            ...
            <div className="container pt--50">
                ...
                <div className="row align-items-center g-5">
                    <div className="col-12 col-lg-6 col-md-12 col-sm-12">
                        <div>
                            <img
                                src="https://assets.rumsan.net/rahat/real-time-monitoring-aa.png"
                                alt=""
                            />
                        </div>
                    </div>
                    <div className="col-12 col-lg-6 col-md-12 col-sm-12 custom-order-flexbox-1">
                        ...
                        <div className="row g-5 pt--10 container">
                            ...
                            >
                                <li>
                                    Real-time monitoring of aid disbursement and
                                    user engagement.
                                </li>
                                <li>
                                    Transparent logs of every transaction and
                                    action taken.
                                </li>
                                <li>
                                    Data-driven insights to improve future
                                    responses.
                                </li>
                            </ol>
                        </div>
