            ...
            >
                <div className="container pt--80">
                    ...
                    {activeTab === "recognition" && (
                        <>
                            {/* Recognition/Funder content (your existing JSX) */}
                            <div className="row row-reverce-sm align-items-center">
                                ...
                                <div className="col-lg-5 col-md-6 col-sm-12 mt_sm--50">
                                    ...
                                    <p>
                                        ...
                                        investment and year-long mentorship.
                                        Proud to contribute to global efforts
                                        using blockchain and open-source
                            ...
                            {/* ...repeat for other recognitions as in your original code... */}
                            <div className="row row-reverce-sm align-items-center pt--80">
                                <div className="col-lg-5 col-md-6 col-sm-12 offset-lg-1 mt_sm--50">
                                    ...
                                    <p>
                                        ...
                                        Innovation Fund for Anticipatory
                                        Humanitarian Action, is collaborating
                                        with the UK Foreign, Commonwealth &
                                        Development Office and esteemed partner
                                        IFRC/Danish Red Cross to enhance its
                                        platform with a blockchain-powered
                                        Anticipatory Action (AA) module.
                                    </p>
                                    <div className="button-group">
                                        <Link
                                ...
                                <div className="row row-reverce-sm align-items-center pt--80">
                                    ...
                                    <div className="col-lg-5 col-md-6 col-sm-12 mt_sm--50">
                                        ...
                                        <p>
                                            Rahat was among the 31 winners of
                                            the MIT Solve 2023 Global Challenges
                                            and one of 6 solvers in the
                                            financial inclusion cohort. We stood
                                            out among 1,500 tech solutions and
                                            are now part of the 2023 Solver
                                            Class.
                                        </p>
                                ...
                                <div className="row row-reverce-sm align-items-center pt--80">
                                    <div className="col-lg-5 col-md-6 col-sm-12 offset-lg-1 mt_sm--50">
                                        <h2 className="mb--20">
                                            Google Startups for Sustainable
                                            Development
                                        </h2>

                                        <p>
                                            Rahat has been selected for the
                                            Google Startups for Sustainable
                                            Development program! As part of the
                                            program, we're working one-on-one
                                            with Google's amazing mentors and
                                            experts to help grow our business.
                                        </p>
                         ...
                         custom-order-flexbox-2"
                                    ...
                                    <div className="col-lg-5 col-md-6 col-sm-12 mt_sm--50">
                                        ...
                                        <p>
                                            We've completed the Google Startups
                                            for Sustainable Development 2023
                                            Impact Measurement Program! We can
                            ...
                            {/* ...add other recognitions as needed... */}
                        </>
                    )}
